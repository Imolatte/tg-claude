...
const locales = {
  en: {
    ...
    "error.invalid_display": "❌ Available: tools, thoughts",
    "error.display_group": "ℹ️ Groups always use thoughts mode.",
    ...
    "cmd.display_current": "🖥 Display: <b>{mode}</b>",
    "cmd.display_set": "✅ Display: <b>{mode}</b>",
    "cmd.display_group": "ℹ️ Groups always use <b>thoughts</b> mode.",
    ...
    "setup.display_prompt": "⚙️ <b>Step 3/4 — Display mode</b>\n\nWhat to show while Claude works?\n\n🔧 <b>Tools</b> — shows which files/commands are being used\n💭 <b>Thoughts</b> — shows Claude's reasoning process\n\n<i>You can switch anytime with /display</i>",
    "setup.display_tools": "🔧 Tools",
    "setup.display_thoughts": "💭 Thoughts",
  ...
  ru: {
    ...
    "error.invalid_display": "❌ Доступные: tools, thoughts",
    "error.display_group": "ℹ️ В группах всегда используется режим thoughts.",
    ...
    "cmd.display_current": "🖥 Дисплей: <b>{mode}</b>",
    "cmd.display_set": "✅ Дисплей: <b>{mode}</b>",
    "cmd.display_group": "ℹ️ В группах всегда используется режим <b>thoughts</b>.",
    ...
    "setup.display_prompt": "⚙️ <b>Шаг 3/4 — Режим дисплея</b>\n\nЧто показывать пока Claude работает?\n\n🔧 <b>Tools</b> — какие файлы/команды используются\n💭 <b>Thoughts</b> — ход мыслей и рассуждения Claude\n\n<i>Можно менять в любой момент через /display</i>",
    "setup.display_tools": "🔧 Tools",
    "setup.display_thoughts": "💭 Thoughts",
