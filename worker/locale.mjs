...
const locales = {
  en: {
    ...
    "sessions.hidden_title": "🗄 <b>Hidden sessions:</b>\n\n",
    "sessions.hidden_empty": "No hidden sessions.",
    "sessions.hidden_btn": "👁 Hidden",
    "sessions.cleanup_btn": "🧹 Cleanup old",
    "sessions.cleanup_prompt": "How many days? Sessions older than N days will be hidden. Send a number.",
    "sessions.cleanup_invalid": "❌ Need a non-negative integer.",
    "sessions.cleanup_done": "🧹 Hidden {count} sessions older than {days} day(s).",
    "sessions.back_btn": "← Back",
    "sessions.hidden_ok": "🗄 Hidden",
    "sessions.unhidden_ok": "↩️ Restored",
    "sessions.active_hidden_notice": "⚠️ Your active session was hidden. Pick another via /sessions or start a new one.",
  ...
  ru: {
    ...
    "sessions.hidden_title": "🗄 <b>Скрытые сессии:</b>\n\n",
    "sessions.hidden_empty": "Нет скрытых сессий.",
    "sessions.hidden_btn": "👁 Скрытые",
    "sessions.cleanup_btn": "🧹 Очистить старые",
    "sessions.cleanup_prompt": "Сколько дней? Сессии старше N дней будут скрыты. Напиши число.",
    "sessions.cleanup_invalid": "❌ Нужно неотрицательное целое число.",
    "sessions.cleanup_done": "🧹 Скрыто {count} сессий старше {days} дн.",
    "sessions.back_btn": "← Назад",
    "sessions.hidden_ok": "🗄 Скрыта",
    "sessions.unhidden_ok": "↩️ Восстановлена",
    "sessions.active_hidden_notice": "⚠️ Твоя активная сессия была скрыта. Выбери другую через /sessions или создай новую.",
